...
Common components.
  ...
  spec.source_files  = "RewardzCommonComponents/**/*.{h,m,swift}","RewardzCommonComponents/**/*.{xib,png,jpg,jpeg }",'RewardzCommonComponents/*.lproj/*.strings', 'RewardzCommonComponents/**/*.lproj/*.strings'
